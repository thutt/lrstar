...
static lrstar_parser::init_func_t NCSA_init_funcs_[2] = {
   NCSA_init_actions,
   NCSA_term_actions
};
...
static lrstar_parser::tact_func_t NCSA_tact_funcs_[2] = {
   NCSA_error,
   NCSA_lookup,
};

// Node action function pointers ...
static lrstar_parser::nact_func_t NCSA_nact_funcs_[11] = {
   0,
   0,
   0,
   0,
