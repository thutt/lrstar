...
namespace verilog {
extern const char *grm_head_symb[230];
extern const char *grm_tact_name[2];
extern const uint8 grm_head_numb[521];
extern const uint16 grm_f_tail[522];
extern const int16 grm_tail[1093];
extern const char *grm_term_symb[177];
extern const int8 grm_arga[177];
extern const uint8 grm_Bm[505];
extern const uint16 grm_Br[569];
extern const uint8 grm_Bc[177];
extern const uint8 grm_Bf[177];
extern const int16 grm_Tm[1592];
extern const uint16 grm_Tr[569];
extern const uint8 grm_Tc[177];
extern const int16 grm_Nm[3577];
extern const uint16 grm_Nr[569];
extern const uint8 grm_Nc[521];
extern const uint16 grm_Rm[153];
extern const int16 grm_Rr[569];
extern const uint8 grm_Rc[177];
extern const int8 grm_PL[521];
extern const int8 grm_tact_numb[177];
