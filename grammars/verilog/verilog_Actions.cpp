...
void verilog_init_actions(verilog_parser_t *parser)
{
      /* Initialization code goes here */
}

void  verilog_term_actions(verilog_parser_t *parser)
{
...
int verilog_lookup(verilog_parser_t *parser, int &t)              // Lookup in symbol table.
{
      int sti;
