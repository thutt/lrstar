...
//    ANTLR_ParserTables.h (generated by LRSTAR 24.0.017)
      ...
      class ANTLR_ParserTables
      {
         ...
         static const uchar  head_numb[   213]; // Head symbol number for a production.
         static const ushort f_tail   [   214]; // First tail in a production.
         static const char   tail     [   327]; // Tail symbol number.
         static const char   arga     [    43]; // Arguments for terminal actions.

         private:
         static const uchar  Bm[   169]       ; // Boolean matrix.
         static const uchar  Br[   148]       ; // Boolean matrix row.
         static const uchar  Bc[    43]       ; // Boolean matrix column.
         static const uchar Bf[    43]       ; // Boolean matrix filter/mask.
         static const short  Tm[   201]       ; // Terminal transition matrix.
         static const uchar  Tr[   148]       ; // Terminal transition matrix row.
         static const uchar  Tc[    43]       ; // Terminal transition matrix column.
         static const short  Nm[   519]       ; // Nonterminal transition matrix.
         static const ushort Nr[   148]       ; // Nonterminal transition matrix row.
         static const uchar  Nc[   213]       ; // Nonterminal transition matrix column.
         static const uchar  Rm[   121]       ; // Reduction matrix.
         static const short  Rr[   148]       ; // Reduction matrix row.
         static const uchar  Rc[    43]       ; // Reduction matrix column.
         static const char   PL[   213]       ; // Production length minus one.

         static const char   tact_numb[    43]; // Terminal action numbers.
