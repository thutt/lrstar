...
namespace COBOL {
    ...
    typedef lrstar_parser_tables_data<const char * const, const char * const, const char * const, const char * const, uint16, uint16, int16, int8, int32, int32, uint8, uint16, uint8, uint8, int16, uint16, uint16, int16, uint16, uint16, uint16, int16, uint8, int8, int32, int32, int32, int32, int8, int32, int32, int32> parser_tables_data;
