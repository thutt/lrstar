...
void PLSQL_init_actions(PLSQL_parser_t *parser)
{
      /* Initialization code goes here */
}

void  PLSQL_term_actions(PLSQL_parser_t *parser)
{
      /* Termination code goes here */
}


int PLSQL_error(PLSQL_parser_t *parser, int &t)
{
...
int PLSQL_lookup(PLSQL_parser_t *parser, int &t)              // Lookup in symbol table.
{
      int sti;
