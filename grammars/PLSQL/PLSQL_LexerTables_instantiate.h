...
#if !defined(__PLSQL__LexerTables_INSTANTIATE)
#define __PLSQL__LexerTables_INSTANTIATE
...
const int templ_lrstar_lexer<T_term_numb, T_Tm, T_Tr, T_Tc>::n_term_numb = 13027;

template<typename T_term_numb, typename T_Tm, typename T_Tr, typename T_Tc>
const int templ_lrstar_lexer<T_term_numb, T_Tm, T_Tr, T_Tc>::n_Tm = 1071672;

template<typename T_term_numb, typename T_Tm, typename T_Tr, typename T_Tc>
const int templ_lrstar_lexer<T_term_numb, T_Tm, T_Tr, T_Tc>::n_Tr = 13027;
...
template class templ_lrstar_lexer<int16, uint16, uint32, uint8>;
