...
int   PGCreateTables::BLD_T (int opt1, int opt2, const char *mark) /* Build Terminal Matrix. */
{
...
int   PGCreateTables::BLD_N (int opt1, int opt2, const char *mark) /* Build Nonterminal Matrix. */
{
...
int   PGCreateTables::BLD_R (int opt1, const char *mark) /* Build Reduction Matrix. */
{
...
void  PGCreateTables::OUT_TOT (int size, int vectors, const char *mark)
{
   char n1[12] = "           ";
   char n2[12] = "           ";
   char n3[12] = "           ";
