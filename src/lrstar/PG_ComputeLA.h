...
private:
   ...
   static void   prt_prod (int p, int dot, const char *before);
   static int    prt_sym (int s, const char *sp);
   static int    printf_sym (int s, const char *sp);
   static void   prt_prod2 (int p, int dot, const char *before);
   static int    prt_sym2 (int s, const char *sp);
