	...
	// AST Traversal Passes.
      ...
      class PG_Parser : public PG_Lexer, public PG_ParserTables
		...
		// Functions ...
			...
			static void    syntax_error    (const char* msg, Token* T, const char* symb);
		...
		// Variables ...
		   ...
		   static int*    F_narg;
			...
			static const char** 	Node_start;
			static const char** 	Nact_start;
			static int    	N_heads;
			static int    	N_nodes;
      ...
      // Functions ...
			...
			static int     add_symbol   (const char*, const char*, int, int);	// Add symbol to symbol table.
