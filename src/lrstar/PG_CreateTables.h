...
/* Copyright 2018, 2023 Paul B Mann.  BSD License. */
		...
		// Functions:
			...
			static int   	BLD_B (int opt1, const char*mark);
			static int   	BLD_T (int opt1, int opt2, const char*mark);
			static int   	BLD_N (int opt1, int opt2, const char*mark);
			static int   	BLD_R (int opt1, const char*mark);
			...
			static void  	OUT_TOT (int size, int vectors, const char *mark);
		};
/* Local Variables:    */
/* mode: c             */
/* c-basic-offset: 3   */
