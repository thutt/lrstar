...
int   PG_ComputeLA::prt_sym (int s, const char *sp)
{
   const char *p;
...
{
   int lb, ntti, orig, next, last, i, t, f, p, n, dot;
...
{
   int lb, ntti, orig, next, last, i, t, f, p, dot;
...
int   PG_ComputeLA::prt_sym2 (int s, const char *sp)
{
   const char *p;
