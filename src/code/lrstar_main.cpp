...
int
cInput::init(char* dir, char* fn, char* ft)
{
...
int
cOutput::init(char* dir, char* fn, char* ft)
{
   strcpy(path, dir);
   strcat(path, fn);
   strcat(path, ft);
...
int
split(char* arg, char* dir, char* fn, char* ft, const char* def)
{
...
int
cOption::init(int argc, char* argv[])
{
   int i, ne, no, nf, help;
   if (argc < 2) {
   Help:
